...
TEST_TRANSLATE = 'Die Struktur verleiht dem Kleid seinen Wohlfühlfaktor'
...
def test_translate(source_text):
    t_text = db_translator.YandexTranslate(source_text, 'en')
    t_text = db_translator.YandexTranslate(t_text, 'en-ru')
    print(t_text.get_result())
